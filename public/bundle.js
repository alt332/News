...
/***/ function(module, exports, __webpack_require__) {
	...
	_reactDom2.default.render(_react2.default.createElement(_reactRouter.Router, { history: _reactRouter.hashHistory, routes: _routes2.default }), document.getElementById('main'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _HackerNews = __webpack_require__(219);
	...
	exports.default = _react2.default.createElement(
	  ...
	  _react2.default.createElement(_reactRouter.IndexRoute, { component: _HackerNews2.default })
	);
	...
	var Nav = function Nav() {
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      "a",
	      { href: "#hacker-news-panel", className: "mdl-tabs__tab is-active" },
	      "Hacker News"
	    ),
	    _react2.default.createElement(
	      "a",
	      { href: "#", className: "mdl-tabs__tab" },
	      "Coming Soon"
	    ),
	    _react2.default.createElement(
	      "a",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _HNHelpers = __webpack_require__(220);

	var _HNHelpers2 = _interopRequireDefault(_HNHelpers);

	var _ItemList = __webpack_require__(222);
	...
	var HackerNews = function (_React$Component) {
	  ...
	  function HackerNews(props) {
	    ...
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(HackerNews).call(this, props));
	  ...
	  _createClass(HackerNews, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      _HNHelpers2.default.fetchTopStories(function (stories) {
	        _this2.setState({
	          items: stories
	        });
	      });
	    ...
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement(_ItemList2.default, { items: this.state.items });
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _firebase = __webpack_require__(221);
	...
	var fetchTopStories = function fetchTopStories(cb) {
	  api.child('topstories').once('value').then(function (data) {
	    return Promise.all(data.val().slice(0, 20).map(function (id) {
	      return fetchItem(id);
	    }));
	  }).then(function (stories) {
	    cb(stories.map(function (story, index) {
	      return story.val();
	    }));
	  }).catch(function (err) {
	    console.log(err);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactTimeago = __webpack_require__(223);
	...
	var ItemList = function (_React$Component) {
	  ...
	  _createClass(ItemList, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        { className: 'mdl-tabs__panel is-active mdl-grid', id: 'hacker-news-panel' },
	        ...
	        _react2.default.createElement(
	          'ol',
	          { className: 'hacker-news-top-story-list mdl-cell--4-col mdl-cell--4-offset' },
	          this.props.items.map(function (item, index) {
	            return _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                'a',
	                { href: '#', className: 'hacker-news-title' },
	                item.title
	              ),
	              _react2.default.createElement(
	                'span',
	              ...
	              _react2.default.createElement(
	                ...
	                _react2.default.createElement(_reactTimeago2.default, { date: item.time }),
	                ' by ',
	                _react2.default.createElement(
	                  'a',
	                  { href: '#' },
